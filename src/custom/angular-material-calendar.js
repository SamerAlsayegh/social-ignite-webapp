...
angular.module("materialCalendar").directive("calendarMd", ["$compile", "$parse", "$http", "$q", "materialCalendar.Calendar", "MaterialCalendarData", "$timeout", "$sce", function ($compile, $parse, $http, $q, Calendar, CalendarData, $timeout, $sce) {
    ...
    return {
        ...
        link: function ($scope, $element, $attrs) {
            ...
            $scope.alterSocialPost = function (socialPostId, $event) {
                $event.stopPropagation();
                $scope.$emit('alterSocialPost', socialPostId);
            };

            $scope.statisticsSocialPost = function (socialPostId, $event) {
                $event.stopPropagation();
            ...
            $scope.$watch("weekLayout", function (old, newVal) {

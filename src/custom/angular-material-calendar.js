...
angular.module("materialCalendar").directive("calendarMd", ["$compile", "$parse", "$http", "$q", "materialCalendar.Calendar", "MaterialCalendarData", "$timeout", function ($compile, $parse, $http, $q, Calendar, CalendarData, $timeout) {

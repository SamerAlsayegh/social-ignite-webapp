define(['../../module'], controllers => {
    return controllers.controller('pageStatisticsController', ['$rootScope', '$scope', '$stateParams', 'Alert', 'SocialAccounts', '$state',
        function ($rootScope, $scope, $stateParams, Alert, SocialAccounts, $state) {
            // $rootScope.allPages = [];
